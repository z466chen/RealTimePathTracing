	...
	, m_shininess(shininess)
{
	...
	UboConstructor::mat_arr[id].mat_data_1 = glm::vec2(m_kd.x, m_kd.y);
	UboConstructor::mat_arr[id].mat_data_2 = glm::vec2(m_kd.z, m_ks.x);
	UboConstructor::mat_arr[id].mat_data_3 = glm::vec2(m_kd.y, m_kd.z);
	UboConstructor::mat_arr[id].mat_data_4 = glm::vec2(ior, m_shininess);
	UboConstructor::mat_arr[id].mat_type = (int) ((type == MaterialType::DIFFUSE)? 
